...
#                            binVal           = cv.QueryHistValue_2D(myHist, hue, sat)
                    ...
                    while seq:
                        ...
                        if w>=20 and h>=20:
                            ...
                            if not((rectCntrX>bestFaceX and rectCntrX<bestFaceX+bestFaceW) and(rectCntrY>bestFaceY and rectCntrY<bestFaceY+bestFaceH)):
                                ...
                                goodRects[goodRectCntr] = (x,y,w,h)
                                goodRectCntr+=1
                        seq = seq.h_next()
                ...
                for i in range(0,goodRectCntr):
                    cv.SetImageROI(skinProbImgOriginal, goodRects[i]);
                    cv.SetImageROI(frameSmall, goodRects[i]);
                    ...
                    if i==0:
                        ...
                        cv.ShowImage("hand1", handNoBGGray2) #hand
        ...
        cv.DestroyWindow("skinProb")
        cv.DestroyWindow("skinProbThreshH")
        cv.DestroyWindow("skinProbThreshHEroDel")
        cv.DestroyWindow("skinProbColor")
        cv.DestroyWindow("skinProbSmoothed")
        cv.DestroyWindow("hand1")
