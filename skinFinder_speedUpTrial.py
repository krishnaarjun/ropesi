...
if __name__ == '__main__':
    ...
    if capture:
        ...
        while True:
            ...
            reScale = 0.3
            horScl = int(biggestW * reScale)
            verScl = int(biggestH * reScale)
                
            #rect of middle of face
#                rect = (biggestX+int(biggestW*0.3),biggestY,int(biggestW*0.5),int(biggestH*0.25)) # forhead
            rect = (biggestX+horScl,biggestY+verScl,biggestW-(horScl*2),biggestH-(verScl*2)) # middle part of face

            pt1 = (int(biggestX), int(biggestY))
            pt2 = (int((biggestX + biggestW)), int((biggestY + biggestH)))
            ...
            if biggestFace>0: 
                ...
                #dilate
                kernelDi = cv.CreateStructuringElementEx(15,18,0,0, cv.CV_SHAPE_RECT)
