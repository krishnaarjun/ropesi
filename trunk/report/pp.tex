...
\begin{document}
	...
	\label{sec:methods}
		...
		A \emph{Gabor wavelet} is creating by defining the size of the wavelet to be created and then by looping over the coordinates of each pixel (\emph{x} and \emph{y}) and applying the following formula:\\
		\begin{table}[!htbp]
		\begin{tabular}{| c |}
			\hline\\
